...
public class TankSelection1 implements Screen {
    final build game;
    private Texture backgroundImage;
    private TextureRegion backgroundTexture;
    OrthographicCamera camera;

    public TankSelection1(final build game) {
        this.game = game;
        backgroundImage = new Texture(Gdx.files.internal("Screens/choose1.png"));
...
//        if (Gdx.input.getX() > 329 && Gdx.input.getY() > 413 && Gdx.input.getX() < 462 && Gdx.input.getY() < 513 && Gdx.input.isTouched()) {
